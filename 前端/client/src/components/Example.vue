                    ...
                    options: [
                        {
                            ...
                            series: [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2002sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2002sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2002sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2003全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2003sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2003sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2003sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2004全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2004sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2004sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2004sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2005全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2005sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2005sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2005sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2006全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2006sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2006sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2006sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2007全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2007sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2007sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2007sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2008全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2008sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2008sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2008sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2009全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2009sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2009sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2009sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2010全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2010sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2010sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2010sum']}
                                    ]}
                            ]
                        },
                        {
                            title : {text: '2011全国二手车交易量'},
                            series : [
                                ...
                                {data: [
                                        {name: '小型车', value: this.dataMap.dataPI['2011sum']},
                                        {name: '中型车', value: this.dataMap.dataSI['2011sum']},
                                        {name: '大型车', value: this.dataMap.dataTI['2011sum']}
                                    ]}
                            ]
                        }
                    ]
