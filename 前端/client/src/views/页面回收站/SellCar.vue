<!-- 
    * @FileDescription: 卖车界面, 需要登陆后才能访问
    * @LastEditTime: 7.10
 -->
        ...
        <el-main>
          <el-row class="parallel-container">
            <el-col :span="12" class="upper-div">
              <el-form ref="form" :label-position="top" :model="form" style="margin-top: 10px;">
                ...
                <el-col :span="6">
                    ...
                    <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                      <el-cascader  v-model="locationValue" :options="locationOptions" @change="handleChange1" style="width: 250px;"></el-cascader>
                    </el-form-item>
                </el-col>
                <!--第二列内容-->
                <el-col :span="6">
                  ...
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-cascader v-model="modelValue" :options="modelOptions" @change="handleChange2" style="width: 250px;"></el-cascader>
                  </el-form-item>
                </el-col>
                <!--第三列内容-->
                <el-col :span="6">
                  ...
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-cascader v-model="timeValue" :options="timeOptions" @change="handleChange1" style="width: 250px;"></el-cascader>
                  </el-form-item>
                </el-col>
                <!--第四列内容-->
                <el-col :span="6">
                  ...
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-input placeholder="万公里" v-model="miles" class="km-input" style="width: 250px;"></el-input>
                  </el-form-item>
                </el-col>
              </el-form>
            </el-col>
    ...
    <div class="block2">
      <el-container>
        <el-main background-color = "rgba(245, 246, 252, 1)">
            ...
            <el-col :span="12" class="lower-div">
              <el-form ref="form" :label-position="top" :model="form" style="margin-top: 20px;">
                ...
                <el-col :span="6">
                  ...
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-cascader v-model="fuelValue" :options="fuelOptions" @change="handleChange2" style="width: 250px;"></el-cascader>
                  </el-form-item>
                  <h2 class="second-title">车身颜色</h2>
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-cascader v-model="colorValue" :options="colorOptions" @change="handleChange2" style="width: 250px;"></el-cascader>
                  </el-form-item>
                </el-col>
                <!--第二列内容-->
                <el-col :span="6">
                  ...
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-cascader v-model="energyValue" :options="energyOptions" @change="handleChange2" style="width: 250px;"></el-cascader>
                  </el-form-item>
                  <h2 class="second-title">驱动方式</h2>
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-cascader v-model="driveValue" :options="driveOptions" @change="handleChange2" style="width: 250px;"></el-cascader>
                  </el-form-item>
                </el-col>
                <!--第三列内容-->
                <el-col :span="6">
                  ...
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-cascader v-model="tranValue" :options="tranOptions" @change="handleChange2" style="width: 250px;"></el-cascader>
                  </el-form-item>

                  <h2 class="second-title">期望售价</h2>
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-input placeholder="万元" v-model="price" class="number-input" style="width: 250px;"></el-input>
                  </el-form-item>
                </el-col>
                <!--第四列内容-->
                <el-col :span="6">
                  ...
                  <el-form-item style="line-height:20px; margin-top: 10px; margin-left: 25px;">
                    <el-input placeholder="以车辆登记证为准" v-model="times" class="number-input" style="width: 250px;"></el-input>
                  </el-form-item>
                  <!--上传图片-->
                  <h2 class="second-title">上传图片</h2>
                  <el-upload action="#" list-type="picture-card" :auto-upload="false" style="margin-top: 10px; margin-left: 25px;">
                    ...
                    <div class="el-upload__tip" slot="tip">请上传45度斜拍车身的照片</div>
                  </el-upload>
          ...
          <div style="display:flex;justify-content:center;margin-top: 15px;margin-bottom: 6px;">
            <el-button type="primary" @click="onSubmit('carinfo')" style="background-color: #3563E9;
                 color: #FFFFFF; width: 250px;">提交
      ...
      methods: {
        ...
        onSubmit(form) {
          ...
          this.$refs[form].validate(valid => {
            if (valid) {
              this.$axios
                  .post("/api/profiles/sellcar", carInfo)
                  .then(res => {
                    /*   console.log("成功提交车辆信息", res.data);*/
                    /*                // 清空表单数据
                this.locationValue = [];
                this.modelValue = [];
                this.timeValue = [];
              ...
              /*              console.log("提交车辆信息失败");
              return false*/
              // 提示用户提交失败
              this.$message.error("提交车辆信息失败，请稍后重试！");
            }
          });
        },
