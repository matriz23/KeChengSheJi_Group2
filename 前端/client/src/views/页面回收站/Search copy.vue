    ...
    <div class="container">
      ...
      >
        ...
        <el-menu-item index="2"
          ><a href="http://localhost:8080/home">我要买车</a></el-menu-item
        >
        <el-menu-item index="3">我要卖车</el-menu-item>
        <el-menu-item index="4">在线估值</el-menu-item>
        <el-menu-item index="5">价格趋势预测</el-menu-item>
    ...
    <div style="height: 650px; display: flex" class="cab">
      <el-scrollbar style="height: 100%">
        ...
        <div>
          ...
          <!-- 上半部分：大矩形卡片 -->
          <el-card class="top-card" :style="{ height: '30em' }">
            <!-- 所在地选择 -->
            <el-row>
            ...
            <el-row>
              <div class="brand-container0">
                ...
                <ul class="brand-list">
                  ...
                  <li
                    class="item"
                    :class="{ hasChecked: selectedBrand === '吉利' }"
                    @click="selectBrand('吉利')"
                  >
                    吉利
                  </li>
                  <li
                  ...
                  <li
                    class="item"
                    :class="{ hasChecked: selectedBrand === '日系' }"
                    @click="selectBrand('日系')"
                  >
                    日系
                  </li>
                  <li
                  ...
                  <li
                    class="item"
                    :class="{ hasChecked: selectedBrand === '红星汽车' }"
                    @click="selectBrand('红星汽车')"
                  >
                    红星汽车
                  </li>
                  <li
            ...
            <el-row>
              <div class="brand-container1">
                ...
                <ul class="brand-list">
                  ...
                  <li
                    class="item"
                    v-for="model in modelList.slice(0, 15)"
                    :key="model"
                  ...
                  <el-dropdown v-if="showMoreModel">
                    ...
                    <el-dropdown-menu slot="dropdown">
                      <el-dropdown-item
                        v-for="model in modelList.slice(15)"
                        :key="model"
                        @click="selectModel(model)"
                        >{{ model }}</el-dropdown-item
                      >
                    </el-dropdown-menu>
                  </el-dropdown>
                </ul>
            ...
            <el-row>
              <div class="brand-container">
                <ul class="brand-list">
                  <li
                    class="item"
                    :class="{ hasChecked: selectedBrand === '综合排序' }"
                  >
                    <span @click="selectBrand('综合排序')">综合排序</span>
                  </li>
                  <li
                    class="item"
            ...
            <div class="card-container">
              ...
              >
                ...
                <div class="card-content">
                  <router-link
                    :to="{ name: 'cardetails', params: { id: item._id } }"
                  >
                    {{ item.title }}
                  </router-link>
                  <div class="car-info">
...
export default {
  ...
  methods: {
    ...
    handleSizeChange(page_size = 20, brand = "") {
      // 切换size
      this.paginations.page_index = 1;
      this.paginations.page_size = page_size;

      // this.tableData = this.allTableData.filter((item, index) => {
      //   return item.brand == brand && index < page_size;
      // });
      this.tableData = this.allTableData.filter((item, index) => {
