              ...
              <el-row>
                  <div class="brand-container2">
                      ...
                      <el-dropdown trigger="click" @command="handleDriveSelect">
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item command="前置后驱">前置后驱</el-dropdown-item>
                          <el-dropdown-item command="双电动四驱">双电动四驱</el-dropdown-item>
                          <el-dropdown-item command="前置四驱">前置四驱</el-dropdown-item>
                          <el-dropdown-item command="中置后驱">中置后驱</el-dropdown-item>
                          <el-dropdown-item command="前置前驱">前置前驱</el-dropdown-item>
                          <el-dropdown-item command="后置四驱">后置四驱</el-dropdown-item>
                          <el-dropdown-item command="后置后驱">后置后驱</el-dropdown-item>
                        </el-dropdown-menu>
                      </el-dropdown>
                      ...
                      <!-- 燃油标准下拉菜单 -->
                      <el-dropdown trigger="click" @command="handleFuelStandardSelect">
                        <span class="brand-more">
                          {{ fuelStandardText }}<i class="el-icon-arrow-down el-icon--right"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">
              ...
              <el-row>
                  <div class="brand-container">
                    ...
                    <ul class="brand-list3">
                      ...
                      <span v-if="selectedFuelStandard!== ''" class="selected-option">
                        燃油标准: {{ selectedFuelStandard }}
                        <i class="el-icon-close" @click="clearselectedFuelStandard"></i>
                      </span>                      
                  </ul>                  
                  </div>
              </el-row>
          ...
          <el-row>          
                  <div class="card-container">
                      <el-card v-for="item in tableData" :key="item.id" class="card-item">
                          <img class="card-img" :src="item.img_url" alt="image" >
...
mounted() {
  ...
  clearSelectedTransmission() {
    ...
    this.$nextTick(() => {
      const dropdown = document.querySelector('.el-dropdown-menu__item.is-selected');
      if (dropdown) {
