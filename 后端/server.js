...
const uploadRouter = require('./routes/api/imgs');

app.use('/api/imgs', uploadRouter); // 假设上传图片的接口路径为 /api/upload

const pyscriptsRouter = require('./routes/api/pyscripts'); // 确保路径正确
// ...
app.use('/api/pyscripts', pyscriptsRouter);
// server.js
